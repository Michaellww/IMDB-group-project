...
<div class="container py-5">
    <div class="row g-4">
        ...
        <div class="col-md-9">
            ...
            <div class="mb-3">
                <input type="text" class="form-control" id="filmographyFilter" placeholder="Search filmography...">
            </div>
...
<script>
    document.getElementById('filmographyFilter').addEventListener('input', function () {
