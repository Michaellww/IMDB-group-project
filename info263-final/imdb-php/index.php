...
<body>
<<<<<<<< HEAD:INFO263 FINAL/imdb-skeleton - Copy/imdb-php/index.php
<main role="main" class="container bg-light">
    ...
    <div class="row align-middle align-items-center py-2">
        <div class="offset-2 col-7 align-middle">
            <input id="search-input" class="form-control" type="text" name="search" placeholder="Search for a Film, Serie, Person, ... to be implemented!" />
========
<main role="main">
    <?php include_once 'navigation.php' ?>
    <?php include_once 'database.php'; ?>
...
>>>>>>>> 3e03e54d25188529fa1997ce05ed5a4eaae41d04:info263-final/imdb-php/index.php
        </div>
